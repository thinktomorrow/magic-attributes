...
use Thinktomorrow\MagicAttributes\Tests\Stubs\EloquentModelStub;
use Thinktomorrow\Trader\Common\Presenters\GetDynamicValue;

class EloquentModelBehaviourTest extends TestCase
{
    private $stub;
    ...
    public function setUp()
    {
        ...
        $this->stub = EloquentModelStub::fake();
    }
    ...
    public function retrieving_value_from_array_plucks_all_values()
    {
        ...
        $this->assertEquals(['one', 'two'], $this->stub->attr('models.box'));
